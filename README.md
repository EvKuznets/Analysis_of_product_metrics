...
3. Оценен месячный retention в оформление заказа с помощью когортного анализа.
4. Определены 5 основных метрик, на которых продакту можно сконцентрироваться, чтобы максимизировать прибыль компании.
5. Выбрана одна из 3 основных гипотез с помощью фреймворка ICE.
6. Сформулирована нужные метрики, на которые ваша гипотеза должна повлиять.
7. Сформулированы выводы о проделанной работе и составлен отчет.
